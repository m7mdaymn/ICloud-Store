        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ActiveTheme = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AccentColor = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LogoLightPath = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LogoDarkPath = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubtitleAr = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SubtitleEn = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ImagePathDesktop = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ImagePathMobile = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LeadLogs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LeadLogs_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductInstallmentPlans", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProductInstallmentPlans_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductId = table.Column<int>(type: "int", nullable: false),
                    PaymentDetailsAr = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PaymentDetailsEn = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductPaymentInfos_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AppleWarrantyEndDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    StoreWarrantyMonths = table.Column<int>(type: "int", nullable: true),
                    StoreWarrantyStartDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    ...
                    OtherAccessoriesText = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UnitMedia", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UnitMedia_Units_UnitId",
                        column: x => x.UnitId,
                        principalTable: "Units",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UnitPaymentInfos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UnitPaymentInfos_Units_UnitId",
                        column: x => x.UnitId,
                        principalTable: "Units",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Brands_SlugAr",
                table: "Brands",
                column: "SlugAr",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Brands_SlugEn",
                table: "Brands",
                column: "SlugEn",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductInstallmentPlans_ProductId",
                table: "ProductInstallmentPlans",
                column: "ProductId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductPaymentInfos_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UnitMedia_UnitId",
                table: "UnitMedia",
                column: "UnitId");

            migrationBuilder.CreateIndex(
                name: "IX_UnitPaymentInfos_UnitId",
                table: "UnitPaymentInfos",
                column: "UnitId",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Wishlists_UserId_TargetType_TargetId",
                table: "Wishlists",
